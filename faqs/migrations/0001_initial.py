# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-11-01 03:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('faq', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='faqs.Faq')),
        ...
        migrations.AddField(
            ...
            name='faq',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='faqs.Faq'),
        ),
    ]
