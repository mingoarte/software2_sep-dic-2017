...
class Sidebar(Pattern):
    ...
    def render(self):
        return render_to_string('patrones/sidebar/view.html', {"pattern": self, "lista": self.elementos})
    # Este método devuelve el html que corresponde a la visualización del patrón
    # en el constructor.
    def render_card(self):
        return render_to_string('patrones/sidebar/build.html', {"pattern": self})
    # Este método devuelve el html que corresponde al formulario de configuración
    # del patrón.
    def render_config_modal(self, request):
        return render_to_string('patrones/sidebar/configurar-modal.html', {"pattern": self})
